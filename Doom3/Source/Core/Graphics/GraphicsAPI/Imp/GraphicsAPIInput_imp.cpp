...
namespace dooms
{
	namespace input
	{
		namespace GraphicsAPIInput
		{
			...
			DOOMS_ENGINE_GRAPHICS_API GRAPHICS_SETMOUSERELATIVEMODE SetMouseRelativeMode{nullptr};
			DOOMS_ENGINE_GRAPHICS_API GRAPHICS_ISWINDOWSHOULDCLOSE IsWindowShouldClose{nullptr};
