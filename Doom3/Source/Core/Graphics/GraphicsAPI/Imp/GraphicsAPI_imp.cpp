...
namespace dooms
{
	namespace graphics
	{
		namespace GraphicsAPI
		{
			...
			DOOMS_ENGINE_GRAPHICS_API GRAPHICS_CONSUME_PENDING_RESIZE ConsumePendingResize{nullptr};
			DOOMS_ENGINE_GRAPHICS_API GRAPHICS_RESIZE_SWAPCHAIN_BUFFERS ResizeSwapChainBuffers{nullptr};
			DOOMS_ENGINE_GRAPHICS_API GRAPHICS_SET_BORDERLESS_FULLSCREEN SetBorderlessFullscreen{nullptr};
			DOOMS_ENGINE_GRAPHICS_API GRAPHICS_IS_BORDERLESS_FULLSCREEN IsBorderlessFullscreen{nullptr};
			...
			DOOMS_ENGINE_GRAPHICS_API GRAPHICS_SETFILLMODE SetFillMode{nullptr};
			...
			*/
			...
			DOOMS_ENGINE_GRAPHICS_API GRAPHICS_DRAWINDEXEDINSTANCED DrawIndexedInstanced{nullptr};
			...
			*/
			...
			DOOMS_ENGINE_GRAPHICS_API GRAPHICS_CREATETEXTUREVIEWOBJECTWITHMIPRANGE CreateTextureViewObjectWithMipRange{ nullptr };
			DOOMS_ENGINE_GRAPHICS_API GRAPHICS_CREATESTAGINGTEXTURE2D CreateStagingTexture2D{ nullptr };
			DOOMS_ENGINE_GRAPHICS_API GRAPHICS_COPYTEXTURE2DTOSTAGINGTEXTURE CopyTexture2DToStagingTexture{ nullptr };
			DOOMS_ENGINE_GRAPHICS_API GRAPHICS_MAPTEXTURE2DFORREAD MapTexture2DForRead{ nullptr };
			DOOMS_ENGINE_GRAPHICS_API GRAPHICS_UNMAPTEXTURE2D UnMapTexture2D{ nullptr };
			DOOMS_ENGINE_GRAPHICS_API GRAPHICS_CREATEQUERY CreateQuery{ nullptr };
			DOOMS_ENGINE_GRAPHICS_API GRAPHICS_DESTROYQUERY DestroyQuery{ nullptr };
			DOOMS_ENGINE_GRAPHICS_API GRAPHICS_BEGINQUERY BeginQuery{ nullptr };
			DOOMS_ENGINE_GRAPHICS_API GRAPHICS_ENDQUERY EndQuery{ nullptr };
			DOOMS_ENGINE_GRAPHICS_API GRAPHICS_GETQUERYRESULT GetQueryResult{ nullptr };
